# Metodología del visor integrado v2.1.0 — candidato científico
...
## 10. Próxima integración bibliográfica

La búsqueda avanzada de la fase 8 se incorporará únicamente después de congelar
su corpus, strings, criterios y resultados. Hasta entonces, el repositorio no
presenta el componente bibliográfico como revisión PRISMA ejecutada.
