...
<title>Visor Democracia Perú 2020–2030 · v2.1.0-rc.5</title>
...
<section class="hero"><h1>Visor Integrado de Democracia del Perú 2020–2030</h1><p>Serie agregada 2020–2025 y tres escenarios exploratorios 2026–2030. El candidato v2.1.0-rc.5 distingue observación oficial, agregado reportado secundariamente, ancla dimensional latente y simulación.</p><div class="meta">Candidato científico-técnico v2.1.0-rc.5 · cierre full-text: 29-08-2026 · 10 000 simulaciones por escenario</div></section>
...
<section id="phase8-fulltext" class="card"><h2>Corpus bibliográfico de soporte</h2><p class="note">Artículo original con búsqueda estructurada auxiliar: 72 informes buscados, 42 evaluados a texto completo, 13 excluidos y 29 incluidos. La literatura contextualiza y fundamenta; no modifica automáticamente parámetros ni probabilidades de escenario.</p><p><a href="../data/prisma_phase8/fulltext_included_29.csv">Corpus incluido</a> · <a href="../data/prisma_phase8/evidence_integration_map_29.csv">Mapa de evidencia</a> · <a href="assets/figura_s1_prisma_fulltext_final.pdf">PRISMA final</a></p></section>
