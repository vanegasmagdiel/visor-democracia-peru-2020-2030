...
def validate():
    ...
    return {'status':'PASS' if not errors else 'FAIL','candidate_version':'2.1.0-rc.5','phase8_state':'fulltext_closed','verified_counts':{'reports_sought':72,'reports_retrieved':42,'reports_assessed':42,'fulltext_excluded':13,'final_included':29,'not_retrieved':30},'ris_records':29,'errors':errors}
def main():
