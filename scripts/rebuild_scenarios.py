...
def build_outputs(config: dict, ensemble: pd.DataFrame) -> None:
    ...
    trajectories.to_csv(D / "scenario_trajectories_2025_2030.csv", index=False, lineterminator="\n")
    bands.to_csv(D / "scenario_sensitivity_bands.csv", index=False, lineterminator="\n")
    category_bands.to_csv(D / "scenario_sensitivity_by_category.csv", index=False, lineterminator="\n")
    parameter_summary.to_csv(D / "scenario_parameter_samples_summary.csv", index=False, lineterminator="\n")
    ...
    summary.to_csv(D / "scenario_summary_2030.csv", index=False, lineterminator="\n")
...
def write_compatibility_coefficients() -> None:
    ...
    pivot.to_csv(D / "scenario_coefficients.csv", index=False, lineterminator="\n")
...
def main() -> None:
    ...
    ensemble.to_csv(D / "peru_2025_anchor_ensemble.csv", index=False, lineterminator="\n")
    anchor_summary.to_csv(D / "peru_2025_anchor_summary.csv", index=False, lineterminator="\n")
